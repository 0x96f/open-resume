...
OpenResume is a powerful open-source resume builder.
...
| **4. Import Saved Resume JSON** | You can export your resume and settings as JSON and import them later to continue editing on another device or browser. |
...
OpenResume is created with the NextJS web framework and follows its project structure. The source code can be found in `src/app`. There are a total of 3 page routes as shown in the table below. (Code path is relative to `src/app`)
...
1. Download the repo `git clone https://github.com/0x96f/open-resume.git`
