...
import { DEFAULT_FONT_COLOR } from "@/features/resume/state/store";
import type { Settings, ShowForm } from "@/features/resume/state/types";
import type { Resume } from "@/features/resume/state/types";
