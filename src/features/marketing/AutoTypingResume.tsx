...
import { initialResumeState } from "@/features/resume/state/store";
import { initialSettings } from "@/features/resume/state/store";
...
export const AutoTypingResume = () => {
  ...
  return (
    <>
      <ResumeIframeCSR documentSize="Letter" scale={isLg ? 0.6 : 0.5}>
        <ResumePDF
          resume={resume}
          settings={{
            ...initialSettings,
